...
public class DAOFactory {
	...
	/*
	 * DAOFactory( String url, String utilisateur, String motdepasse ) { this.url =
	 * url; this.utilisateur = utilisateur; this.motdepasse = motdepasse; }
	 */

	// t'instanciee la factory
	 ...
	 * DriverManager.getConnection( url, utilisateur, motdepasse ); }
	 */
